    ...
    return (
        <>
            ...
            <div className={`h-screen transition-opacity duration-1000 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`} >
                <img className='w-36 absolute h-full mt-56 right-0' src='wave-side.png' alt='wave'/>
                <img className='w-36 absolute h-full mt-56 left-0' src='wave-transparent-left.png' alt='wave'/>
