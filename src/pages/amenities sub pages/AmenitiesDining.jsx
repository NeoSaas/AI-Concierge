                            ...
                            <div className="md:grid md:grid-cols-12 md:gap-6 items-center">
                                ...
                                <div className="max-w-xl md:max-w-none md:w-full mx-auto md:col-span-7 lg:col-span-6" data-aos="fade-right">
                                    <div className="md:pr-4 lg:pr-12 xl:pr-16">
                                        ...
                                        <button className='text-xl mx-20 bg-[#0066FF] px-6 py-2 text-white font-medium rounded-md transition duration-300 ease-in-out mt-2' onClick={() => handleButton(0)} >Cafe Morning Menu</button>
                                        <button className='text-xl mx-20 bg-[#0066FF] px-6 py-2 text-white font-medium rounded-md transition duration-300 ease-in-out mt-1' onClick={() => handleButton(1)} >Cafe Evening Menu</button>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="md:grid md:grid-cols-12 md:gap-6 items-center">
                                ...
                                <div className="max-w-xl md:max-w-none md:w-full mx-auto md:col-span-7 lg:col-span-6" data-aos="fade-left">
                                    <div className="md:pl-4 lg:pl-1 xl:pl-16">
                                        ...
                                        <button className='text-2xl mx-20 bg-[#0066FF] px-6 py-2 text-white font-medium rounded-md transition duration-300 ease-in-out' onClick={() => handleButton(2)} >Make a reservation</button>
                                    </div>
                                </div>
                            </div>
                            {/* 4th item */}
                            <div className="md:grid md:grid-cols-12 md:gap-6 items-center">
                                ...
                                <div className="max-w-xl md:max-w-none md:w-full mx-auto md:col-span-7 lg:col-span-6" data-aos="fade-left">
                                    <div className="md:pl-4 lg:pl-12 xl:pl-16">
                                        ...
                                        <button className='text-2xl mx-20 bg-[#0066FF] px-6 py-2 text-white font-medium rounded-md transition duration-300 ease-in-out' onClick={() => handleButton(3)} >Make a reservation</button>
                                    </div>
                                </div>
                            </div>
                        </div>
