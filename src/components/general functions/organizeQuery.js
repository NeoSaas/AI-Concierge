...
export default async function organizeQuery(selectedActivities) {
    ...
    const promptTemplate = `
        ...
        Consider the tags associated with each business INDIVIDUALLY, meaning if there are three options selected and some restaurants match the first two options include those in your suggestion but if none match the third tag still recommend the other businesses.
