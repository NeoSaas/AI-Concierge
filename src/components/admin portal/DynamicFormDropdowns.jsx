        ...
        {(() => {
            switch (values.business_type_tag1) {
                ...
                case 'Art Gallery':
                    return (
                        <div>
                        <label htmlFor="sub_type_business_tags" className="flex flex-row items-center">{values.business_type_tag1}&nbsp;Sub Tags <FaInfoCircle className='mx-2' /></label>
                        <Field as="select" name="sub_type_business_tags" id="sub_type_business_tags" className="appearance-none rounded-none relative w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm" placeholder="Business Tags (comma-separated)" >
                            <option value="">Select...</option>
                            {subTypeOptions[values.business_type_tag1].map(option => (
                            <option key={option} value={option}>
                                {option}
          ...
          {(() => {
              switch (values.business_type_tag2) {
                  ...
                  case 'Art Gallery':
                      return (
                          <div>
                          <label htmlFor="sub_type_business_tags2" className="flex flex-row items-center">{values.business_type_tag2}&nbsp;Sub Tags <FaInfoCircle className='mx-2' /></label>
                          <Field as="select" name="sub_type_business_tags2" id="sub_type_business_tags2" className="appearance-none rounded-none relative w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm" placeholder="Business Tags (comma-separated)" >
                              <option value="">Select...</option>
                              {subTypeOptions[values.business_type_tag2].map(option => (
                              <option key={option} value={option}>
                                  {option}
            ...
            {(() => {
                switch (values.business_type_tag3) {
                    ...
                    case 'Art Gallery':
                        return (
                            <div>
                            <label htmlFor="sub_type_business_tags3" className="flex flex-row items-center">{values.business_type_tag3}&nbsp;Sub Tags <FaInfoCircle className='mx-2' /></label>
                            <Field as="select" name="sub_type_business_tags3" id="sub_type_business_tags3" className="appearance-none rounded-none relative w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm" placeholder="Business Tags (comma-separated)" >
                                <option value="">Select...</option>
                                {subTypeOptions[values.business_type_tag3].map(option => (
                                <option key={option} value={option}>
                                    {option}
