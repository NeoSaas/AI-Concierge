            ...
            {loading ?
              ...
              <div>
                ...
                <div className='flex flex-col'>
                  ...
                  <p className='text-3xl text-black mx-auto text-center mb-10 mt-1'>Here are the best options for you! We Found {displayBusinesses.length} Please scroll to see them</p>
