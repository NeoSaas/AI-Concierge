...
function BusinessCardDisplay({ business, setIsOpen, setRestaurantLink}) {
  ...
  return (
    <div className="bg-white rounded-lg shadow-md p-4 w-[80%] mx-auto hover:scale-105 duration-300 ease-in-out h-80" onClick={() => {setRestaurantLink(business[0].directions_url); setIsOpen(true);}} >
      ...
      <div className='bottom-0 mt-28 inline-block'>
